...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#updateRemarkBtn").click(function(){
			var id = $("#remarkId").val();  //获取 更新备注信息的隐藏id
			$.ajax({
				...
				success:function(data){
					if(data.success){
						...
						* */
						//修改的由 noteContent   editBy,   editTime
	...
	function deleteRemark(id){
		...
		$.ajax({
			...
			//放回 success  true/false

			success:function(data){
				if(data.success){
					//alert("删除成功");
					//showRemarkList();  不能直接覆盖，因为这个保留着被删除的信息，
					$("#"+id).remove();
